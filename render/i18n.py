...
LOCALES: dict[str, dict[str, Any]] = {
    ...
    "zh_HK": {
        # Hong Kong CVs are expected to be bilingual (English alongside 繁體中文),
        # most strongly in FSI, government, Big-4, and multinationals. We render
        # bilingual section headings ("Work Experience 工作經驗") but leave the
        # body text to the profile's _zh_HK locale overrides (falling back to
        # canonical English). Photo is optional; HKID is NEVER on a CV.
        "language": "zh",
        "style": "noun_phrase",
        "photo": "optional",
        "personal_fields": ["email", "phone", "location", "linkedin", "github", "website"],
        ...
        "filename_style": "{last}{first}_{role_slug}_{locale}_{yyyymm}",
        "headings": {
            "summary": "Personal Profile 個人簡介",
            "skills": "Professional Skills 專業技能",
            "ai_overview": "AI-Assisted Work Overview AI 協作工作概覽",
            "projects": "AI-Assisted Projects AI 協作專案經歷",
            "experience": "Work Experience 工作經驗",
            "education": "Education 學歷",
            "certifications": "Certifications 專業證照",
            "awards": "Awards 獲獎紀錄",
            "talks": "Talks 演講 / 分享",
            "hobbies": "Interests 興趣",
            "target_role": "Position Applied For 應徵職位",
            "last_30d": "Last 30 Days 近 30 天活躍度",
            "ai_tools": "AI Tools Used 使用的 AI 工具",
            "capabilities": "Capability Breadth 跨職能能力",
            "period": "Period 期間",
            "sessions": "Sessions 對話次數",
            "breadth": "Breadth 職能涵蓋",
            "stack": "Tech Stack 技術堆疊",
            "domain_tags": "Domain 領域標籤",
            "impact": "Impact 成果",
            "key_achievements": "Key Achievements 主要成果",
            "other_short": "Other Short Engagements 其他短期合作",
            "tailored_for": "Tailored For 投遞目標",
            "languages": "Language Proficiency 語言能力",
        },
    },
    "zh_CN": {
        "language": "zh",
